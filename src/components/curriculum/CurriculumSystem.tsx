...
export const CURRICULUM_PHASES: CurriculumPhase[] = [
    {
        ...
        modules: [
            ...
            { id: "stone-2", title: "Fork Mastery", description: "Double attacks", puzzleCount: 25, requiredAccuracy: 75, unlocked: true, completed: false, progress: 0, ratingMin: 600, ratingMax: 1000, themes: ["fork", "doubleAttack"] },
            { id: "stone-3", title: "Discovery & Double Check", description: "Hidden threats", puzzleCount: 25, requiredAccuracy: 75, unlocked: true, completed: false, progress: 0, ratingMin: 800, ratingMax: 1200, themes: ["discoveredAttack", "doubleCheck"] },
            { id: "stone-4", title: "Back Rank Tactics", description: "Mate patterns", puzzleCount: 30, requiredAccuracy: 80, unlocked: true, completed: false, progress: 0, ratingMin: 1000, ratingMax: 1400, themes: ["backRankMate", "mateIn1", "mateIn2"] },
            { id: "stone-5", title: "Deflection & Decoy", description: "Advanced combinations", puzzleCount: 30, requiredAccuracy: 80, unlocked: true, completed: false, progress: 0, ratingMin: 1200, ratingMax: 1600, themes: ["deflection", "attraction", "interference"] },
        ],
    },
    {
        id: "flow",
        ...
        modules: [
            { id: "flow-1", title: "Opening Principles", description: "Development & center", puzzleCount: 15, requiredAccuracy: 70, unlocked: true, completed: false, progress: 0, ratingMin: 600, ratingMax: 1000, themes: ["opening", "hangingPiece"] },
            { id: "flow-2", title: "Pawn Structure", description: "The skeleton of position", puzzleCount: 20, requiredAccuracy: 75, unlocked: true, completed: false, progress: 0, ratingMin: 1000, ratingMax: 1400, themes: ["advancedPawn", "quietMove"] },
            { id: "flow-3", title: "Piece Activity", description: "Optimal placement", puzzleCount: 20, requiredAccuracy: 75, unlocked: true, completed: false, progress: 0, ratingMin: 1200, ratingMax: 1600, themes: ["trappedPiece", "sacrifice"] },
            { id: "flow-4", title: "King Safety", description: "Castling & attacks", puzzleCount: 25, requiredAccuracy: 80, unlocked: true, completed: false, progress: 0, ratingMin: 1400, ratingMax: 1800, themes: ["kingsideAttack", "attackingF2F7"] },
            { id: "flow-5", title: "Prophylaxis", description: "Preventing opponent's plans", puzzleCount: 25, requiredAccuracy: 85, unlocked: true, completed: false, progress: 0, ratingMin: 1600, ratingMax: 2000, themes: ["defensiveMove", "zugzwang"] },
        ],
    },
    {
        id: "sage",
        ...
        modules: [
            { id: "sage-1", title: "King & Pawn", description: "Opposition & triangulation", puzzleCount: 20, requiredAccuracy: 75, unlocked: true, completed: false, progress: 0, ratingMin: 800, ratingMax: 1200, themes: ["pawnEndgame", "endgame"] },
            { id: "sage-2", title: "Rook Endgames", description: "The Lucena & Philidor", puzzleCount: 25, requiredAccuracy: 80, unlocked: true, completed: false, progress: 0, ratingMin: 1200, ratingMax: 1600, themes: ["rookEndgame", "endgame"] },
            { id: "sage-3", title: "Minor Piece Endings", description: "Bishop vs Knight", puzzleCount: 20, requiredAccuracy: 80, unlocked: true, completed: false, progress: 0, ratingMin: 1400, ratingMax: 1800, themes: ["bishopEndgame", "knightEndgame", "endgame"] },
            { id: "sage-4", title: "Queen Endings", description: "Perpetual checks & wins", puzzleCount: 20, requiredAccuracy: 85, unlocked: true, completed: false, progress: 0, ratingMin: 1600, ratingMax: 2000, themes: ["queenEndgame", "endgame"] },
            { id: "sage-5", title: "Theoretical Draws", description: "Fortress & stalemate", puzzleCount: 25, requiredAccuracy: 90, unlocked: true, completed: false, progress: 0, ratingMin: 1800, ratingMax: 2200, themes: ["endgame", "master"] },
        ],
    },
];
